    ...
    <div class="Product__feature Product__feature--personal1">
      ...
      <div class="Product__featureStep">
        <div class="step step1">
          ...
          <div class="image">
            <img src="../src/asset/image/product/receipt_1.png" height="328"/>
          </div>
        </div>
        <div class="step step2">
          ...
          <div class="image">
            <img src="../src/asset/image/product/receipt_2.png" height="328"/>
          </div>
        </div>
        <div class="step step3">
          ...
          <div class="image">
            <img src="../src/asset/image/product/receipt_3.png" height="160"/>
          </div>
        </div>
        <div class="step step4">
          ...
          <div class="image">
            <img src="../src/asset/image/product/receipt_4.png" height="328"/>
          </div>
        </div>
    ...
    <div class="Product__feature Product__feature--personal2">
      ...
      <div class="Product__featureStep">
        <div class="step step1">
          ...
          <div class="image">
            <img src="../src/asset/image/product/give_1.png" height="328"/>
          </div>
        </div>
        <div class="step step2">
          <div class="textWrapper">
          ...
          <div class="image">
            <img src="../src/asset/image/product/give_2.png" height="328"/>
          </div>
        </div>
        <div class="step step3">
          <div class="textWrapper">
          ...
          <div class="image">
            <img src="../src/asset/image/product/give_3.png" height="328"/>
          </div>
        </div>
        <div class="step step4">
          <div class="textWrapper">
          ...
          <div class="image">
            <img src="../src/asset/image/product/give_4.png" height="328"/>
          </div>
        </div>
        <div class="step step5">
          <div class="textWrapper">
          ...
          <div class="image">
            <img src="../src/asset/image/product/give_5.png" height="328"/>
          </div>
        </div>
      </div>
    </div>
