  ...
  <div class="Product Product--office">
          ...
          <div class="Product__storyList">
            <div class="Product__storyItem Product__storyItem--1">
              <div class="textWrapper">
                ...
                <a href="#">もっと詳しく<i class="icon-arrow"></i></a>
              </div>
              <div class="image"></div>
            </div>
      ...
      <div class="Product__featureItem">
        ...
        <div class="Product__featureItemImage">
          <div class="itemWrapper">
            <div class="image"><img src="../src/asset/image/product/dashboard_1.png" width="470" height="320"/></div>
            <div class="text">デスクトップ：ウェブアプリケーション</div>
          </div>
          <div class="itemWrapper">
            <div class="image"><img src="../src/asset/image/product/dashboard_2.png" width="148" height="319"/></div>
    ...
    <div class="Product__feature Product__feature--office2">
      ...
      <div class="Product__featureItem">
        <div class="Product__featureItemList">
          <div class="item">
            <div class="image"><img src="../src/asset/image/product/app_flow_1.png" width="200" height="398"/></div>
            <p class="text">アプリトップ</p>
          </div>
          <div class="arrow"><span></span></div>
          <div class="item">
            <div class="image"><img src="../src/asset/image/product/app_flow_2.png" width="200" height="398"/></div>
            <p class="text">写真撮影</p>
          </div>
          <div class="arrow"><span></span></div>
          <div class="item">
            <div class="image"><img src="../src/asset/image/product/app_flow_3.png" width="200" height="398"/></div>
            <p class="text">情報登録</p>
          </div>
          <div class="arrow"><span></span></div>
          <div class="item">
            <div class="image"><img src="../src/asset/image/product/app_flow_4.png" width="200" height="398"/></div>
    ...
    <div class="Product__feature Product__feature--office3">
      ...
      <div class="Product__featureItem">
        ...
        <div class="Product__featureItemImage">
          <div class="itemWrapper">
            <div class="image"><img src="../src/asset/image/product/push_1.png" width="230" height="313" class="no-border"/></div>
            <div class="text">自動通知</div>
          </div>
          <div class="itemWrapper">
            <div class="image"><img src="../src/asset/image/product/push_2.png" width="329" height="329" class="no-border"/></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="Product__feature Product__feature--office4">
      ...
      <div class="Product__featureItem">
        ...
        <div class="Product__featureItemImage">
          <div class="itemWrapper">
            <div class="image"><img src="../src/asset/image/product/data_1.png" width="580" height="373" class="no-border"/></div>
          </div>
        </div>
      </div>
    </div>

  <?php include ('component/product_info.html'); ?>
  <?php include ('component/inquiry.html'); ?>
  </div><!--/.Product-->
</section><!--/.Content-->
